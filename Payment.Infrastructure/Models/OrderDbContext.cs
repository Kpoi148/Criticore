...
//        => optionsBuilder.UseSqlServer("Server=ADMIN-PC;Database=CriticoreDB;User ID=sa;Password=admin@123;Trust Server Certificate=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<CopyleaksReport>(entity =>
        {
            ...
            entity.HasOne(d => d.User).WithMany(p => p.CopyleaksReports)
                .HasForeignKey(d => d.UserId)
                .HasConstraintName("FK_CopyleaksReports_Users");
        });
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__Orders__C3905BAF33F14D84");
            ...
            entity.Property(e => e.DurationInMonths).HasDefaultValue(1);

            entity.Property(e => e.EndDate).HasColumnType("datetime");

            entity.Property(e => e.PackageName)
                .HasMaxLength(100)
                .HasDefaultValue("Gói 1 tháng");
            ...
            //    .HasConstraintName("FK__Orders__Confirme__59C55456");

            //entity.HasOne(d => d.User).WithMany(p => p.OrderUsers)
            //    .HasForeignKey(d => d.UserId)
            //    .OnDelete(DeleteBehavior.ClientSetNull)
            //    .HasConstraintName("FK__Orders__UserID__58D1301D");
        });
